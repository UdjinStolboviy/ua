...
var mask = function mask(selector) {
  var setCursorPosition = function setCursorPosition(pos, elem) {
    ...
    } else if (elem.createTextRenge) {
      var rang = elem.createTextRenge();
      rang.collapse(true);
      rang.moveEnd('character', pos);
      rang.moveStart('chracter', pos);
      rang.select();
    }
  };
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    trigger.forEach(function (item) {
      item.addEventListener('click', function (e) {
        ...
        document.body.style.overflow = "hidden"; // Отменяет  прокрутку  страници
